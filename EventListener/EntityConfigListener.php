...
class EntityConfigListener
{
    ...
    /** @var EntityProxyUpdateConfigProviderInterface */
    ...
    public function setEntityProxyUpdateConfigProvider(EntityProxyUpdateConfigProviderInterface $configProvider)
    {
        $this->entityProxyUpdateConfigProvider = $configProvider;
    }
