...
Feature: Serialized fields usage in segments
  In order to manage data of serialized fields
  As an Administrator
  I want to have an ability to use serialized fields in segments
  ...
  Scenario: Check segment creation using serialized fields
  ...
  Scenario: Checking segment grid sorting by serialized fields
  ...
  Scenario: Checking segment grid filtering by serialized fields
    Given I reset grid
